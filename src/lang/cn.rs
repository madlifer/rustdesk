...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "你的信息"),
        ("desk_tip", "支持者可通过下面的ID信息和一次性密码远程协助你的计算机。"),
        ("Password", "密码"),
        ("Ready", "已连接"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 Squad.ICU 远程协助网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "服务正在运行"),
        ("Service is not running", "服务未运行"),
        ("not_ready_status", "未就绪，请检查网络连接"),
        ("Control Remote Desktop", "远程桌面连接"),
        ("Transfer file", "传输文件"),
        ("Connect", "连接"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 Squad.ICU 远程协助 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 Squad.ICU 远程协助 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 Squad.ICU 远程协助 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 Squad.ICU 远程协助 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [Squad.ICU 远程协助 Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep Squad.ICU 远程协助 background service", "保持 Squad.ICU 远程协助 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 Squad.ICU 远程协助 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("Enable audio", "允许传输音频"),
        ("Unlock Network Settings", "请勿解锁网络设置(已配置好，乱动要出问题)"),
        ("Server", "服务器"),
        ...
        ("Show Squad.ICU 远程协助", "显示 Squad.ICU 远程协助"),
        ("This PC", "此电脑"),
        ("or", "或"),
        ("Continue with", "使用"),
        ("Elevate", "提权"),
        ...
        ("One-time Password", "一次性密码(双击下方以复制)"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 Squad.ICU 远程协助 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 Squad.ICU 远程协助 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 Squad.ICU 远程协助 的 UAC 窗口点击确认。"),
        ...
        ("verify_Squad.ICU 远程协助_password_tip", "验证 Squad.ICU 远程协助 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 Squad.ICU 远程协助 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("upgrade_Squad.ICU 远程协助_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，Squad.ICU 远程协助 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("powered_by_me", "由 Squad.ICU 远程协助 提供支持"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 Squad.ICU 远程协助 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 Squad.ICU 远程协助 后台服务"),
        ...
        ("About Squad.ICU 远程协助", "关于 Squad.ICU 远程协助"),
